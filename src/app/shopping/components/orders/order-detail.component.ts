              ...
              <div class="flex flex-col gap-2 max-w-md ml-auto">
                ...
                @if (order()!.tax) {
                  <div class="flex justify-between">
                    <span>IVA (13%):</span>
                    <span class="font-semibold">
                      {{ order()!.currency }} {{ order()!.tax | number:'1.2-2' }}
                    </span>
                  </div>
                }
                ...
                @if (order()!.shipping_cost) {
                  <div class="flex justify-between">
                    <span>Envío:</span>
                    <span class="font-semibold">
                      {{ order()!.currency }} {{ order()!.shipping_cost | number:'1.2-2' }}
                    </span>
                  </div>
                }
          ...
          <div>
            ...
            <p-card header="Información de Pago">
              <div class="flex flex-col gap-3">
                ...
                <div>
                  <div class="text-sm text-muted-color mb-1">Método de Pago</div>
            ...
            <p-card header="Fechas" class="mt-4">
              <div class="flex flex-col gap-3">
                ...
                @if (order()!.confirmed_at) {
                  <div>
                    <div class="text-sm text-muted-color mb-1">Fecha de Confirmación</div>
                    <div>{{ order()!.confirmed_at | date:'dd/MM/yyyy HH:mm' }}</div>
                  </div>
                }
                
                @if (order()!.shipped_at) {
                  <div>
                    <div class="text-sm text-muted-color mb-1">Fecha de Envío</div>
                    <div>{{ order()!.shipped_at | date:'dd/MM/yyyy HH:mm' }}</div>
                  </div>
                }
                
                @if (order()!.delivered_at) {
                  <div>
                    <div class="text-sm text-muted-color mb-1">Fecha de Entrega</div>
                    <div>{{ order()!.delivered_at | date:'dd/MM/yyyy HH:mm' }}</div>
                  </div>
                }
              </div>
            </p-card>
